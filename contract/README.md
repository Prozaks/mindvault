...
| `top_tags(limit)`                                                      | —                     | `limit: u32` — capped at `TOP_TAGS_CAP` (20)                                                                                                                                                                                                                           | `Vec<TagPopularity>`           | Return tags ordered by descending successful-registration count, with deterministic lexicographic tie-breaking. Counters saturate at `u32::MAX`.                                                                                                  |
